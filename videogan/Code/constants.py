...
#TRAIN_DIR = os.path.join(DATA_DIR, '/i-LIDS-VID/cam1/Train/')
TRAIN_DIR = os.path.join(DATA_DIR,'PRID2011/multi_shot/Train/')



# directory of unprocessed test frames
#TEST_DIR = '/home/liu/Documents/i-LIDS-VID/sequences/cam2/'
TEST_DIR = '/home/liu/Documents/PRID2011/multi_shot/cam_b/'

#TEST_DIR = os.path.join(DATA_DIR,'PRID2011/multi_shot/Test/')

#TEST_DIR = os.path.join(DATA_DIR, 'cam1/Test1/')
